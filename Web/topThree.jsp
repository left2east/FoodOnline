...
<table width="80%" height="22"  border="0" align="top" cellpadding="0" cellspacing="0"  bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
 ...
 <td  align="center" class="linkLeixing" <%if(id.equals(bigForm.getId().toString())){out.println("bgcolor='#DAD9D9'");}%>>
 <a href="goodsAction.do?action=12&big=<%=bigForm.getId()%>&id=<%=bigForm.getId()%>"><%=bigForm.getBigName()%></a></td>
