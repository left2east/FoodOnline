...
<table width="1000" height="150%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="680" bgcolor="#FFFFFF" class="linkBlack"><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="20%" height="638" rowspan="3" valign="top" background="image/zuocedaohangbeijing.jpg">
        <jsp:include page="../leftOne.jsp"/></td>
		
        <td width="70%" height="35" align="center" valign="middle"><jsp:include page="../topThree.jsp"/></td>
...
<br>
		<table width="96%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#819BBC">
          <tr>
            <td width="36%" rowspan="4" height="120"><input name="pricture<%=i%>" type="image" src="<%=bigForm.getPicture()%>" width="420" height="138"></td>
            <td width="64%" height="30"><div align="center"><%=bigForm.getGoodName()%></div></td>
          </tr>
          <tr>
