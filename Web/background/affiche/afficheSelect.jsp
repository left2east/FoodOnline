 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>公告信息的查询</b></font></div></td>
      </tr>
    </table>
<br><br>
      ...
      AfficheForm form=(AfficheForm)list.get(i);
        ...
        <tr>
          ...
          <td><div align="center">
          <a href="afficheAction.do?action=4&id=<%=form.getId()%>">修改</a>
          &nbsp;&nbsp;<a href="afficheAction.do?action=6&id=<%=form.getId()%>">查询内容</a>
          &nbsp;&nbsp;<a href="javascript:deleteAffiche('<%=form.getId()%>')">删除</a>
          </div></td>
      <%}%>  </tr>
      </table>
	  <br>
