 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>修改公告信息</b></font></div></td>
      </tr>
    </table>
<br><br>
	  ...
	  <form name="form" method="post" action="afficheAction.do?action=5&id=<%=affiche.getId()%>" onSubmit="return checkEmpty(form)">
        <table width="90%" height="243"  border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="77%">&nbsp;&nbsp;&nbsp;<input name="name" type="text" size="118" value="<%=affiche.getName()%>"></td>
          </tr>
          <tr>
            <td height="208"><div align="center"><font size="4"><b>公告内容<br>(不超过200字)</b></font></div>              </td>
            <td>&nbsp;&nbsp;
              <textarea name="content" cols="100" rows="16"><%=affiche.getContent()%></textarea></td>
          </tr>
        </table>
        <p>
