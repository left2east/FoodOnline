...
window.alert("您输入特价加湿器的价格应该与原来的价格是等价的，请重新输入！！！");
return false;
}
if(document.form.free.value-document.form.now.value>0){
window.alert("您输入特价加湿器的价格应该比原来的价格高，请重新输入！！！");
return false;
}
...
<table width="1000" height="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <div align="center"><br>	
      ...
      <tr >
        <td bgcolor="#E6E6E6" ><div align="center"><font size="4" color="#990000"><b>设置特价加湿器</b></font></div></td>
      </tr>
    </table>
      ...
      <br><br>  <form name="form" method="post" action="goodsAction.do?action=11&id=<%=goodsForm.getId()%>&mark=1" onSubmit="return checkEmpty(form)">
        ...
        <table width="90%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="13%" class="linkRed"> <a href="javascript:history.back();">返回加湿器信息</a></td>
          </tr>
        </table>
