...
<body>
<table width="1000" height="100%"  border="0" align="center" cellpadding="0" cellspacing="0"  bordercolor="#FFFFFF" bordercolordark="#000000" bordercolorlight="#FFFFFF">
  <tr valign="bottom">
  ...
  <tr><td width="24%" height="41" ><jsp:include page="../../leftManager.jsp"/>  </td></tr>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center" class="style1"><font size="4">订单的查询</font></div></td>
      </tr>
    </table>
	<br>
	<br>
...
<%}else{%>
 <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="18%" class="linkRed"><a href="orderAction.do?action=0">返回</a></td>
   </tr>
 </table>
