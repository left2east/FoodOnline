 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>管理员信息的查询</b></font></div></td>
      </tr>
    </table>
<br><br>
	    ...
	    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
          <td width="20%" height="20" colspan="4"><div align="right"><a href="managerAction.do?action=7">修改本账号密码</a>&nbsp;&nbsp;&nbsp;</div></td>
        <tr>
        </table>
