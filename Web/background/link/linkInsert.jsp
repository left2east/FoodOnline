...
window.alert("网站名称不能多于20字！");
return false;
}

if(document.form.address.value.length >20){
window.alert("输入的网址太长！");
return false;
}
}
</script>
 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>添加网站信息</b></font></div></td>
      </tr>
    </table>
<br><br>
