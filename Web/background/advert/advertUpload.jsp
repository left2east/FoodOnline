...
session.setAttribute("advertAddress",address);
%>
<head>
 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>添加网站图片</b></font></div></td>
      </tr>
    </table>
<br><br>

	  <form action="advertDealPicture.jsp" method="post" enctype="multipart/form-data"  name="form" onSubmit="return checkEmpty(form)" >
        <table width="90%" height="60"  border="1" cellpadding="0" cellspacing="0">
          ...
          <tr>
		    ...
		    <tr>
            <td height="30" colspan="2"><div align="center" class="style1">注意：只能上传“*.gif”与“*.jpg”的图片,文件不能大于500KB</div></td>
          </tr>
...
<br><br>
	  	...
	  	<meta http-equiv="refresh" content="3;URL=advertAction.do?action=1">
	  <%}%>
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
	  <p>&nbsp;</p>
