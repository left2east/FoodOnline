 ...
 <tr><td width="24%" height="40"><jsp:include page="../../leftManager.jsp"/>  </td></tr> 
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>添加广告信息</b></font></div></td>
      </tr>
    </table>
<br><br>

	  <form name="form" method="post" action="advertAction.do?action=2" onSubmit="return checkEmpty(form)">
        <table width="90%" height="243"  border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="77%">&nbsp;&nbsp;&nbsp;<input name="name" maxlength="100" type="text" size="118"></td>
          </tr>
