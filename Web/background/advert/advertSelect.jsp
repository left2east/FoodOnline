...
%>
 ...
 function deleteAdvert(date) {
  if(confirm("确定要删除吗？")){
    window.location="advertAction.do?action=3&id="+date;
	}
  }
 </script>
<html>
 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>广告信息的查询</b></font></div></td>
      </tr>
    </table>
<br><br>
	  ...
	  <table width="90%"  border="1" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="19%"><div align="center">广告标题</div></td>
          <td width="27%"><div align="center">广告发布时间</div></td>
          <td width="37%"><div align="center">操作</div></td>
        </tr>
		     <%for(int i=start;i<over;i++){
      AdvertForm form=(AdvertForm)list.get(i);
          %>
        <tr>
          ...
          <td><div align="center">            
             <a href="advertAction.do?action=6&id=<%=form.getId()%>">查询内容</a>
             &nbsp;<a href="<%=form.getAdvertPicture()%>" target="_blank">查看图片</a>
             &nbsp;<a href="advertAction.do?action=4&id=<%=form.getId()%>">修改</a>
             &nbsp;<a href="javascript:deleteAdvert('<%=form.getId()%>')">删除</a>
             </div></td>
      <%}%>  </tr>
      </table>
	  <br>
      ...
      上一页
        <%}else{%>
        <a href="advertAction.do?action=0&i=<%=number-1%>">上一页</a></td>
          <%}%>
          <td width="18%"><%if(maxPage<=(number+1)){%>
            下一页
              <%}else{%>
              <a href="advertAction.do?action=0&i=<%=number+1%>">下一页</a></td>
          <%}%>

          <td width="20%">
            <div align="right"><a href="advertAction.do?action=1">添加广告信息</a>&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
