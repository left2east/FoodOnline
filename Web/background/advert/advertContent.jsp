 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="30"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font size="4" color="#990000"><b>查看广告信息</b></font></div></td>
      </tr>
    </table>
<br><br>
        ...
        <table width="90%" height="243"  border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="77%">&nbsp;<%=advert.getName()%></td>
          </tr>
          
            <tr>
            <td width="23%" height="208"><div align="center"><font size="4"><b>广告内容</b></font></div></td>
            <td width="77%">&nbsp;<%=advert.getContent()%></td>
          </tr>
          
          <tr>
            <td width="23%" height="30"><div align="center"><font size="4"><b>链接地址 </b></font></div></td>
            <td width="77%">&nbsp;<%=advert.getAdvertAddress()%></td>
          </tr>
        </table>
